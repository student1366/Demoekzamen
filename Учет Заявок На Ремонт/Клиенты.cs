...
namespace УчетЗаявокНаРемонт
{
    public partial class Клиенты : Form
    {
        ...
        string[] rows = new string[] { "Код", "Фамилия", "Имя", "Отчество", "Телефон", "Пользователь" };
        string table = "Клиенты";
        ...
        {
            if (String.IsNullOrWhiteSpace(textBox1.Text) || String.IsNullOrWhiteSpace(textBox2.Text) || String.IsNullOrWhiteSpace(textBox3.Text) || String.IsNullOrWhiteSpace(textBox4.Text) || String.IsNullOrWhiteSpace(textBox6.Text))
            {
        ...
        private void CreateColumns()
        {
            ...
            dataGridView1.Columns.Add("adres2", "Телефон");
            dataGridView1.Columns.Add("adres3", "Пользователь");
            ...
            for (int index = 0; index < dataGridView1.Rows.Count; index++)
            {
                ...
                switch (rowState)
                {
                    ...
                    case RowState.Modified:
                        ...
                        string[] values = new string[] { number, name, phone, adres1, adres2, adres3 };
        ...
        private void Change()
        {
            ...
            if (checkTextBoxes())
            {
                ...
                adres2 = textBox5.Text;
                adres3 = textBox6.Text;

                dataGridView1.Rows[selectedRowIndex].SetValues(number, name, phone, adres1, adres2, adres3);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (checkTextBoxes())
            {
                ...
                string[] values = new string[] { name, phone, adres1, adres2, adres3 };
